document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.tagName === 'TEXTAREA' && input.hasAttribute('required') && value === '') {
                showError(input, isRTL ? 'هذا الحقل مطلوب' : 'This field is required');
                return false;
            }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'adabdd4d-823b-4989-9e78-149e7227483a',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'adabdd4d-823b-4989-9e78-149e7227483a';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'adabdd4d-823b-4989-9e78-149e7227483a';
